...
// import random sentence generator from txtgen//
...
//the resquest and response of the number of sentences in chance//
app.get('/chance/:sentenceCount', async (req, res) => {
  // Instantiate Chance so it can be used
var chance = new Chance();

// Use Chance to find my_random-string//
var my_random_string = chance.string();

const sentenceCount = req.params.sentenceCount

const sentence = chance.sentence({ words: parseInt(sentenceCount) })
//response from json
